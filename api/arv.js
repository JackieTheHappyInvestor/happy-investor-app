export default async function handler(req, res) {
  ...
  try {
    ...
    const url = `https://api.rentcast.io/v1/avm/value?address=${encodeURIComponent(address)}&compCount=20&radius=1.5&daysOld=180`;
    ...
    // Sort closest first, cap at 5
    tierComps.sort((a, b) => (a.distance || 0) - (b.distance || 0));
    ...
    return res.status(200).json({
      price: data.price || data.priceRangeLow || 0,
